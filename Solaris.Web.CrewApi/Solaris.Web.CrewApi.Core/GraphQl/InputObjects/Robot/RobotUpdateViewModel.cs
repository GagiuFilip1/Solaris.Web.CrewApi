...
{
    public class RobotUpdateViewModel : InputObjectGraphType<Models.Entities.Robot>
    {
        public RobotUpdateViewModel()
        {
            Field(x => x.Id, type: typeof(NonNullGraphType<IdGraphType>)).Description("The id of the robot to be updated");
            Field(x => x.Name);
